...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/ashboardOperator">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/ashboardOperator">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/formKegiatan">
                    ...
                    <span>Form Jadwal Kegiatan</span></a>
            </li>
                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Data Nichhhh</h6>
                                </div>
                                <div class="mt-2 ml-3">
